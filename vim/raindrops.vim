...
hi diffNewFile ctermfg=10
hi diffFile ctermfg=12
hi diffLine ctermfg=7
hi diffIndexLine ctermfg=14
hi healthError ctermfg=0 ctermbg=1
hi healthSuccess ctermfg=0
hi healthWarning ctermfg=0
...
hi Type ctermfg=11
hi vimGroup ctermfg=1
hi vimHiGroup ctermfg=9
